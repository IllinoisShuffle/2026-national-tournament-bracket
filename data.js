...
const QUARTERS = [
  { id: 'red',    name: 'RED LINE',    color: '#c60c30', busNum: '50',  busName: 'DAMEN',     side: 'L', pos: 'top' },
  { id: 'blue',   name: 'BLUE LINE',   color: '#00a1de', busNum: '49',  busName: 'WESTERN',   side: 'L', pos: 'bottom' },
  { id: 'green',  name: 'GREEN LINE',  color: '#009b3a', busNum: '72',  busName: 'NORTH',     side: 'R', pos: 'top' },
  { id: 'orange', name: 'ORANGE LINE', color: '#f9461c', busNum: '56',  busName: 'MILWAUKEE', side: 'R', pos: 'bottom' },
];
